# Generated by Powerlevel10k configuration wizard on 2021-09-01 at 04:12 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 23401.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, round heads, slanted tails, 2 lines, disconnected,
# left frame, darkest-ornaments, compact, many icons, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%245F╭ '
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%245F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%245F╰'
