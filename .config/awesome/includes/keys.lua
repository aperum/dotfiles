...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "p", function()
    awful.spawn.with_shell(rofi_password)
  end, {
    description = "show the menubar",
    group = "launcher",
  }),
  awful.key({ modkey, "Shift" }, "p", function()
    awful.spawn.with_shell(rofi_ppassword)
  end, {
    description = "show the menubar",
    group = "launcher",
  }),
