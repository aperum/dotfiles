...
local wanted_matrix = {
  ...
  docker_compose_language_service = { "hastur", "azathoth", "guardian" },
  -- efm = { "hastur", "azathoth", "guardian" },
  gopls = { "hastur", "azathoth", "guardian" },
  html = { "hastur", "azathoth", "guardian" },
  jsonls = { "hastur", "azathoth", "guardian" },
  lemminx = { "hastur", "azathoth", "guardian", "raspberrypi" },
  marksman = { "hastur", "azathoth", "guardian", "raspberrypi" },
  lua_ls = { "hastur", "azathoth", "guardian" },
